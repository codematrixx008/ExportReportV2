...
namespace API1.Controllers.General
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private string reactURL = "https://192.168.1.74:3000";
        ...
        private void SetRefreshTokenCookie(string refreshToken)
        {
            var cookieOptions = new CookieOptions
            {
                ...
                Secure = false,     // Use Secure cookie for HTTPS
        ...
        public IActionResult Login2()
        {
            ...
            return new RedirectResult($"{reactURL}/redirectLogin?rdtkn={reqToken}");
        ...
        public IActionResult RedirectloginUser()
        {
            ...
            return Ok(new { redirectUrl = $"{reactURL}/profile" });
        }
